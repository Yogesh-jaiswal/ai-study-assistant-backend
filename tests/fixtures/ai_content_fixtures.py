...
def create_ai_content(builder, upload, endpoint_key: str, result_key: str, payload: dict) -> dict:
    """Create AI content by generating it through the provided builder."""
...
def generated_summary(
    ...
    """Fixture to generate a summary for a completed upload."""
    payload={
        "upload_ids": [
...
def second_generated_summary(
    ...
    """Fixture to generate a summary for a second completed upload."""
    payload={
        "upload_ids": [
...
def generated_exam(
    ...
    """Fixture to generate an exam for a completed upload."""
    payload={
        "upload_ids": [
            completed_upload["upload_id"]
        ],
...
def second_generated_exam(
    ...
    """Fixture to generate an exam for a second completed upload."""
    payload={
        "upload_ids": [
            second_completed_upload["upload_id"]
        ],
