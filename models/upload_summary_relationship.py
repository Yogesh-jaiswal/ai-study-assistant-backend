...
class UploadSummaryRelationship(db.Model):
    ...
    upload: Mapped["Upload"] = db.relationship("Upload", back_populates="upload_summary_relationship", lazy="raise_on_sql")
    summary: Mapped["Summary"] = db.relationship("Summary", back_populates="upload_summary_relationship", lazy="raise_on_sql")